...
│   ├── 01_parse_metadata.py      # Parse codebook and generate questions
│   └── 02_extract_insights.py    # Extract statistical insights
...
```bash
cd examples/anes_example/scripts
